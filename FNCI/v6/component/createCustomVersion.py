...
FNCI_API = "FNCI v6 Create Custom Component Version API"
ENDPOINT_URL = config.v6_BASEURL + "component/createCustomVersion/"
...
def create_custom_component_version(componentID, componentVersionName, authToken):
    ...
    RESTAPI_URL = ENDPOINT_URL + str(componentID) + "/" +  str(componentVersionName)
