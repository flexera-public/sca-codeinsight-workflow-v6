...
FNCI_API = "FNCI v6 Get Component Version by Name API"
ENDPOINT_URL = config.v6_BASEURL + "component/componentVersionDataByName"
...
def get_component_version_data_by_name(componentId, versionName, authToken):
    ...
    RESTAPI_URL = ENDPOINT_URL  + "?componentId=" + str(componentId) + "&versionName=" + str(versionName)
